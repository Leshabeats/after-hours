...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DqOq7xx8.mjs");
...
var manifest = {
	"312cc4c76b93808e167b28b44c7e85f7c4831e4fd407b06f434215ad06429a26": {
		functionName: "getMissions_createServerFn_handler",
		importer: () => import("./api-roh_8uRD.mjs")
	},
	"72cd0d7e350396b571665d424a8ada7e320b6c7e710888c950abe7ef0df2059f": {
		functionName: "briefMission_createServerFn_handler",
		importer: () => import("./api-roh_8uRD.mjs")
	},
	"c267e25339dc1bbda6b57677f2426dd0cca0360094cff5a113a520044c3dc622": {
		functionName: "getMission_createServerFn_handler",
		importer: () => import("./api-roh_8uRD.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-IV7pLPzu2.mjs").then((n) => n.t),
