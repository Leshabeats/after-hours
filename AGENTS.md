...
- Catalog shows projects, issues live at `/r/$owner/$repo`. Worlds are Web, Stars, Linux. A language chip adds that language's ecosystem and its libraries, and keeps the world: direction projects whose GitHub language matches stay in their own section.
